<div x-data="{show: @entangle('show')}">
    <div>
        <button @click="show = true" type="button" class="block px-6 py-2 border rounded-md shadow-sm text-center font-semibold tracking-wide text-white bg-green-400 hover:text-white hover:bg-green-600">
            {{ _("Add attachment") }}
        </button>
    </div>
